...
class RestaurantManagementSystem:
    def __init__(self, root):
        ...
        self.items = {
            ...
            "Salad": 250,
            "Russian Salad": 350,
            "Chicken Fried Rice": 400,
            "Beef Fried Rice": 300,
            "Dragon Chicken": 450,
            "Honey Chilli Chicken": 490,
    ...
    def create_gui(self):
        heading = tk.Label(self.root, text="Aruvi Restaurant", font=("Helvetica", 24, "bold"), bg="#f0f0f0",fg='#DC143C')
        heading.pack(pady=10)
        details_frame = tk.LabelFrame(self.root, text="Customer Details",fg="#A52A2A",font=("Helvetica", 24, "bold"),bg='#008B8B')
        ...
        name_entry.configure(validatecommand=(name_entry.register(self.validate_name), "%P"))
        ...
        menu_frame = tk.LabelFrame(self.root, text="Menu",fg="#A52A2A",font=("Helvetica", 24, "bold"),bg='#5F9EA0')
        ...
        print_bill_button = tk.Button(buttons_frame, text="Print Bill", command=self.show_bill_popup ,bg='#FF7F50')
        print_bill_button.pack(side="left", padx=5)

        past_record_button = tk.Button(buttons_frame, text="Past Records", command=self.past_records, bg='#DEB887')
        past_record_button.pack(side="left", padx=5)

        clear_selection_button = tk.Button(buttons_frame, text="Clear Selection", command=self.clear_selection,bg='#D2691E')
